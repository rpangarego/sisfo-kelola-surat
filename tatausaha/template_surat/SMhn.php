...
<!-- Page Heading -->
<h1 class="h3 mb-2 text-gray-800">Surat Permohonan Izin</h1>
<hr>
...
<div class="row">
	<div class="col col-md-6">
		...
		<div class="form-group">
		    ...
		    <textarea name="tentang" id="tentang" rows="3" class="form-control" required autocomplete="off"></textarea>
		</div>
		<div class="form-group">
		    <label for="pihak_pembuat">Pihak Pembuat</label>
		    <input type="text" class="form-control" id="pihak_pembuat" name="pihak_pembuat" autocomplete="off" required>
		</div>
		<div class="form-row">
