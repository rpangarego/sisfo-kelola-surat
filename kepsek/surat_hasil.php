            ...
            <?php foreach ($rows as $row): ?>
              <tr>
                ...
                <td>
                  ...
                  <a href="aksi?act=surat_disposisi&id=<?= $row->id; ?>&surat=<?= $row->no_surat; ?>&tgl_dari=<?= $_GET['tgl_dari']; ?>&tgl_sampai=<?= $_GET['tgl_sampai']; ?>&jenis=<?= $_GET['jenis']; ?>&kategori=<?= $_GET['kategori']; ?>" class="btn btn-sm btn-outline-primary" onclick="return confirm('Disposisi surat <?= $row->no_surat; ?>?')">Disposisi</a>
                </td>
              </tr>
